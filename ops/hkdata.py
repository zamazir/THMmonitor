...
thm_bytes =    [("Timestamp",                           "<I",  None,                                  None),
               ...
               ("ADCS Mainpanel Z+ Temperature BMX",    "<h",  beaconconvert.interpretBMX055,           22),
               ("ADCS Mainpanel Z+ Temperature OW1",    "<h",  beaconconvert.interpretDS18B20,          23),
               ("ADCS Mainpanel Z+ Temperature OW2",    "<h",  beaconconvert.interpretDS18B20,          24),
               ("ADCS Mainpanel Z+ Temperature OW3",    "<h",  beaconconvert.interpretDS18B20,          25),
               ("ADCS Sidepanel Z- Temperature BMX",    "<h",  beaconconvert.interpretBMX055,           37),
               ("ADCS Sidepanel Z- Temperature OW1",    "<h",  beaconconvert.interpretDS18B20,          38),
